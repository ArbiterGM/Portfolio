  ...
  return (
    <>
      <motion.div
        ...
        viewport={{ once: true }}
        id="contact"
        className="flex flex-col justify-center pt-[7rem] md:pt-[0px] items-center gap-[1rem] my-[6rem] lg:w-[1000px] lg:mx-auto lg:items-start lg:my-[10rem]"
      >
        <div>
        ...
        <div className="flex flex-col justify-center items-center gap-[1rem] lg:items-start lg:relative">
          ...
          <div className="lg:w-full lg:mt-[2rem] mx-auto">
            <form action="https://getform.io/f/aejyngkb" method="POST">
              <div className="flex flex-col gap-[20px] p-[20px] lg:p-[0px]">
                <div className="flex flex-col gap-[20px] md:flex-row ">
                  <div className="flex flex-col gap-[5px] w-1/2">
                    ...
                    <input
                      className="p-[15px] w-[300px] lg:w-full bg-[--lightNavy] rounded-[5px] focus:outline-none focus:border-[--green] border border-[--lightNavy] duration-150 text-[--textLight]"
                      type="text"
                      name="name"
                      placeholder="Name"
                      autoComplete="off"
                  ...
                  <div className="flex flex-col gap-[5px] w-1/2">
                    ...
                    <input
                      className="p-[15px] w-[300px] bg-[--lightNavy] lg:w-full rounded-[5px] focus:outline-none focus:border-[--green] border border-[--lightNavy] duration-150 text-[--textLight]"
                      type="email"
                      name="email"
                      placeholder="Email"
                      autoComplete="off"
              ...
              <div className="w-[300px] md:w-[620px] lg:w-[1000px] mx-auto">
